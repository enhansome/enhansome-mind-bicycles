...
* [Mech lang](http://mech-lang.org/) / [repo](https://github.com/mech-lang/mech) ⭐ 292 | 🐛 201 | 🌐 Rust | 📅 2026-08-25. Language for developing data-driven, reactive systems like animations, games, and robots. It makes composing, transforming, and distributing data easy, allowing you to focus on the essential complexity of your problem.
...
* [Orca](https://wiki.xxiivv.com/#orca) / [repo](https://github.com/hundredrabbits/orca) ⭐ 5,071 | 🐛 39 | 🌐 JavaScript | 📅 2025-11-16 / [🎥 video](https://www.youtube.com/watch?v=RaI_TuISSJE). Orca is an esoteric programming language, designed to create procedural sequencers.
...
* [Unison](http://unisonweb.org/posts/) / [repo](https://github.com/unisonweb/unison) ⭐ 6,715 | 🐛 1,268 | 🌐 Haskell | 📅 2026-08-19. Next-generation programming platform.
* [IPLD](https://ipld.io/) / [repo](https://github.com/ipld/ipld) ⭐ 1,352 | 🐛 83 | 🌐 Nunjucks | 📅 2026-08-25. IPLD is a set of standards and implementations for creating decentralized data-structures that are universally addressable and linkable. These structures will allow us to do for data what URLs and links did for HTML web pages.
...
* [MPS](https://www.jetbrains.com/mps/) / [repo(mirror)](https://github.com/JetBrains/MPS) ⭐ 1,656 | 🐛 7 | 🌐 JetBrains MPS | 📅 2026-08-25. Create your own Domain Specific Language.
...
* [Hazel](http://hazel.org/) / [repo](https://github.com/hazelgrove/hazel) ⭐ 1,139 | 🐛 428 | 🌐 Reason | 📅 2026-08-25. Live functional programming environment featuring typed holes.
...
* [Xstate](https://xstate.js.org/docs) / [repo](https://github.com/davidkpiano/xstate) ⭐ 30,059 | 🐛 123 | 🌐 TypeScript | 📅 2026-08-24. State machines and statecharts for the modern web.
...
* [rete.js](https://rete.js.org) / [repo](https://github.com/retejs/rete) ⭐ 12,225 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24. JavaScript framework for visual programming and creating node editor.
* [Enso](https://enso.org/) / [repo](https://github.com/enso-org/enso) ⭐ 7,438 | 🐛 325 | 🌐 Java | 📅 2026-08-10. Formerly Luna. Hybrid visual and textual functional programming for data processing.
