...
* [Mech lang](http://mech-lang.org/) / [repo](https://github.com/mech-lang/mech) ⭐ 296 | 🐛 232 | 🌐 Rust | 📅 2026-09-23. Language for developing data-driven, reactive systems like animations, games, and robots. It makes composing, transforming, and distributing data easy, allowing you to focus on the essential complexity of your problem.

## Debugging Tools

* [CodeCrumbs](https://codecrumbs.io/) / [repo](https://github.com/Bogdan-Lyashenko/codecrumbs) ⭐ 2,708 | 🐛 29 | 🌐 JavaScript | 📅 2021-09-11. Learn, design or document codebase by putting breadcrumbs in source code.
...
* [Orca](https://wiki.xxiivv.com/#orca) / [repo](https://github.com/hundredrabbits/orca) ⭐ 5,098 | 🐛 39 | 🌐 JavaScript | 📅 2025-11-16 / [🎥 video](https://www.youtube.com/watch?v=RaI_TuISSJE). Orca is an esoteric programming language, designed to create procedural sequencers.
...
* [Unison](http://unisonweb.org/posts/) / [repo](https://github.com/unisonweb/unison) ⭐ 6,737 | 🐛 1,272 | 🌐 Haskell | 📅 2026-08-19. Next-generation programming platform.
...
* [MPS](https://www.jetbrains.com/mps/) / [repo(mirror)](https://github.com/JetBrains/MPS) ⭐ 1,660 | 🐛 7 | 🌐 JetBrains MPS | 📅 2026-09-23. Create your own Domain Specific Language.
...
* [Hazel](http://hazel.org/) / [repo](https://github.com/hazelgrove/hazel) ⭐ 1,156 | 🐛 457 | 🌐 Reason | 📅 2026-09-23. Live functional programming environment featuring typed holes.
...
* [Guesstimate](https://www.getguesstimate.com/) / [repo](https://github.com/getguesstimate/guesstimate-app/) ⭐ 2,367 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-11. A spreadsheet for things that aren’t certain.
...
* [Xstate](https://xstate.js.org/docs) / [repo](https://github.com/davidkpiano/xstate) ⭐ 30,155 | 🐛 132 | 🌐 TypeScript | 📅 2026-09-23. State machines and statecharts for the modern web.
...
* [rete.js](https://rete.js.org) / [repo](https://github.com/retejs/rete) ⭐ 12,271 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-13. JavaScript framework for visual programming and creating node editor.
...
* SwiftVPL / [repo](https://github.com/NathanFlurry/VisualProgrammingLanguage) ⭐ 1,208 | 🐛 1 | 🌐 Swift | 📅 2026-03-11 / [🎥 video](https://www.youtube.com/watch?v=BNWC_OF5Q-Y). A visual programming language written in Swift that assembles to executable Swift code. WWDC '18 scholarship submission.
...
* [Visual Programming Codex](https://github.com/ivanreese/visual-programming-codex) ⭐ 1,498 | 🐛 127 | 📅 2026-05-28
