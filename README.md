...
* [Mech lang](http://mech-lang.org/) / [repo](https://github.com/mech-lang/mech) ⭐ 296 | 🐛 232 | 🌐 Rust | 📅 2026-09-26. Language for developing data-driven, reactive systems like animations, games, and robots. It makes composing, transforming, and distributing data easy, allowing you to focus on the essential complexity of your problem.
...
* [Orca](https://wiki.xxiivv.com/#orca) / [repo](https://github.com/hundredrabbits/orca) ⭐ 5,099 | 🐛 39 | 🌐 JavaScript | 📅 2025-11-16 / [🎥 video](https://www.youtube.com/watch?v=RaI_TuISSJE). Orca is an esoteric programming language, designed to create procedural sequencers.
...
* [Unison](http://unisonweb.org/posts/) / [repo](https://github.com/unisonweb/unison) ⭐ 6,739 | 🐛 1,272 | 🌐 Haskell | 📅 2026-08-19. Next-generation programming platform.
...
* [MPS](https://www.jetbrains.com/mps/) / [repo(mirror)](https://github.com/JetBrains/MPS) ⭐ 1,660 | 🐛 7 | 🌐 JetBrains MPS | 📅 2026-09-26. Create your own Domain Specific Language.
...
* [Lamdu](http://www.lamdu.org/) / [repo](https://github.com/lamdu/lamdu) ⭐ 1,898 | 🐛 25 | 🌐 Haskell | 📅 2026-09-25. An open source live programming environment.
* [Hazel](http://hazel.org/) / [repo](https://github.com/hazelgrove/hazel) ⭐ 1,157 | 🐛 460 | 🌐 Reason | 📅 2026-09-26. Live functional programming environment featuring typed holes.
...
* [Guesstimate](https://www.getguesstimate.com/) / [repo](https://github.com/getguesstimate/guesstimate-app/) ⭐ 2,381 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-11. A spreadsheet for things that aren’t certain.
...
* [Xstate](https://xstate.js.org/docs) / [repo](https://github.com/davidkpiano/xstate) ⭐ 30,168 | 🐛 134 | 🌐 TypeScript | 📅 2026-09-26. State machines and statecharts for the modern web.
