...
* [Mech lang](http://mech-lang.org/) / [repo](https://github.com/mech-lang/mech) ⭐ 295 | 🐛 210 | 🌐 Rust | 📅 2026-09-08. Language for developing data-driven, reactive systems like animations, games, and robots. It makes composing, transforming, and distributing data easy, allowing you to focus on the essential complexity of your problem.
...
* [BespokeSynth](http://hihigogo.com/bespoke/) / [repo](https://github.com/awwbees/BespokeSynth) ⭐ 143 | 🐛 0 | 🌐 C++ | 📅 2026-09-02 / [🎥 video](https://www.youtube.com/watch?v=2-ApB_gnAJE) / [reddit](https://www.reddit.com/r/BespokeSynth/). A new modular DAW for OSX.
...
* [MPS](https://www.jetbrains.com/mps/) / [repo(mirror)](https://github.com/JetBrains/MPS) ⭐ 1,657 | 🐛 7 | 🌐 JetBrains MPS | 📅 2026-09-08. Create your own Domain Specific Language.
...
* [Hazel](http://hazel.org/) / [repo](https://github.com/hazelgrove/hazel) ⭐ 1,147 | 🐛 447 | 🌐 Reason | 📅 2026-09-08. Live functional programming environment featuring typed holes.
...
* [Xstate](https://xstate.js.org/docs) / [repo](https://github.com/davidkpiano/xstate) ⭐ 30,096 | 🐛 123 | 🌐 TypeScript | 📅 2026-09-08. State machines and statecharts for the modern web.
...
* [rete.js](https://rete.js.org) / [repo](https://github.com/retejs/rete) ⭐ 12,238 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24. JavaScript framework for visual programming and creating node editor.
