...
* [Mech lang](http://mech-lang.org/) / [repo](https://github.com/mech-lang/mech) ⭐ 296 | 🐛 232 | 🌐 Rust | 📅 2026-09-25. Language for developing data-driven, reactive systems like animations, games, and robots. It makes composing, transforming, and distributing data easy, allowing you to focus on the essential complexity of your problem.
...
* [Unison](http://unisonweb.org/posts/) / [repo](https://github.com/unisonweb/unison) ⭐ 6,738 | 🐛 1,272 | 🌐 Haskell | 📅 2026-08-19. Next-generation programming platform.
...
* [MPS](https://www.jetbrains.com/mps/) / [repo(mirror)](https://github.com/JetBrains/MPS) ⭐ 1,660 | 🐛 7 | 🌐 JetBrains MPS | 📅 2026-09-25. Create your own Domain Specific Language.
...
* [Lamdu](http://www.lamdu.org/) / [repo](https://github.com/lamdu/lamdu) ⭐ 1,898 | 🐛 26 | 🌐 Haskell | 📅 2026-09-25. An open source live programming environment.
* [Hazel](http://hazel.org/) / [repo](https://github.com/hazelgrove/hazel) ⭐ 1,157 | 🐛 459 | 🌐 Reason | 📅 2026-09-25. Live functional programming environment featuring typed holes.
...
* [Guesstimate](https://www.getguesstimate.com/) / [repo](https://github.com/getguesstimate/guesstimate-app/) ⭐ 2,368 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-11. A spreadsheet for things that aren’t certain.
...
* [Xstate](https://xstate.js.org/docs) / [repo](https://github.com/davidkpiano/xstate) ⭐ 30,166 | 🐛 135 | 🌐 TypeScript | 📅 2026-09-25. State machines and statecharts for the modern web.
...
* [rete.js](https://rete.js.org) / [repo](https://github.com/retejs/rete) ⭐ 12,275 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-13. JavaScript framework for visual programming and creating node editor.
...
* [Visual Programming Codex](https://github.com/ivanreese/visual-programming-codex) ⭐ 1,500 | 🐛 127 | 📅 2026-05-28
