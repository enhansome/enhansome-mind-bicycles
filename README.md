...
* [Mech lang](http://mech-lang.org/) / [repo](https://github.com/mech-lang/mech) ⭐ 291 | 🐛 200 | 🌐 Rust | 📅 2026-08-20. Language for developing data-driven, reactive systems like animations, games, and robots. It makes composing, transforming, and distributing data easy, allowing you to focus on the essential complexity of your problem.
...
* [Orca](https://wiki.xxiivv.com/#orca) / [repo](https://github.com/hundredrabbits/orca) ⭐ 5,066 | 🐛 39 | 🌐 JavaScript | 📅 2025-11-16 / [🎥 video](https://www.youtube.com/watch?v=RaI_TuISSJE). Orca is an esoteric programming language, designed to create procedural sequencers.
...
* [Unison](http://unisonweb.org/posts/) / [repo](https://github.com/unisonweb/unison) ⭐ 6,709 | 🐛 1,269 | 🌐 Haskell | 📅 2026-08-19. Next-generation programming platform.
...
* [MPS](https://www.jetbrains.com/mps/) / [repo(mirror)](https://github.com/JetBrains/MPS) ⭐ 1,654 | 🐛 7 | 🌐 JetBrains MPS | 📅 2026-08-20. Create your own Domain Specific Language.
...
* [Hazel](http://hazel.org/) / [repo](https://github.com/hazelgrove/hazel) ⭐ 1,128 | 🐛 426 | 🌐 Reason | 📅 2026-08-20. Live functional programming environment featuring typed holes.
...
* [Xstate](https://xstate.js.org/docs) / [repo](https://github.com/davidkpiano/xstate) ⭐ 30,037 | 🐛 121 | 🌐 TypeScript | 📅 2026-08-20. State machines and statecharts for the modern web.
...
* [rete.js](https://rete.js.org) / [repo](https://github.com/retejs/rete) ⭐ 12,223 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24. JavaScript framework for visual programming and creating node editor.
* [Enso](https://enso.org/) / [repo](https://github.com/enso-org/enso) ⭐ 7,437 | 🐛 325 | 🌐 Java | 📅 2026-08-10. Formerly Luna. Hybrid visual and textual functional programming for data processing.
...
* [Visual Programming Codex](https://github.com/ivanreese/visual-programming-codex) ⭐ 1,492 | 🐛 126 | 📅 2026-05-28
