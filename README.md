...
* [Eve](http://witheve.com/) / [repo](https://github.com/witheve/Eve) ⭐ 7,224 | 🐛 71 | 🌐 TypeScript | 📅 2018-03-20 / [🕰️ history](https://github.com/pel-daniel/mind-bicyles/blob/master/history.md#eve) ⭐ 377 | 🐛 5 | 📅 2024-06-26. Programming designed for humans.
* [Mech lang](http://mech-lang.org/) / [repo](https://github.com/mech-lang/mech) ⭐ 291 | 🐛 199 | 🌐 Rust | 📅 2026-08-16. Language for developing data-driven, reactive systems like animations, games, and robots. It makes composing, transforming, and distributing data easy, allowing you to focus on the essential complexity of your problem.
...
* [Orca](https://wiki.xxiivv.com/#orca) / [repo](https://github.com/hundredrabbits/orca) ⭐ 5,062 | 🐛 39 | 🌐 JavaScript | 📅 2025-11-16 / [🎥 video](https://www.youtube.com/watch?v=RaI_TuISSJE). Orca is an esoteric programming language, designed to create procedural sequencers.
...
* [Unison](http://unisonweb.org/posts/) / [repo](https://github.com/unisonweb/unison) ⭐ 6,701 | 🐛 1,271 | 🌐 Haskell | 📅 2026-08-12. Next-generation programming platform.
...
* [MPS](https://www.jetbrains.com/mps/) / [repo(mirror)](https://github.com/JetBrains/MPS) ⭐ 1,653 | 🐛 7 | 🌐 JetBrains MPS | 📅 2026-08-16. Create your own Domain Specific Language.
...
* [Hazel](http://hazel.org/) / [repo](https://github.com/hazelgrove/hazel) ⭐ 1,126 | 🐛 430 | 🌐 Reason | 📅 2026-08-15. Live functional programming environment featuring typed holes.
...
* [Xstate](https://xstate.js.org/docs) / [repo](https://github.com/davidkpiano/xstate) ⭐ 30,017 | 🐛 127 | 🌐 TypeScript | 📅 2026-08-15. State machines and statecharts for the modern web.
...
* [rete.js](https://rete.js.org) / [repo](https://github.com/retejs/rete) ⭐ 12,199 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24. JavaScript framework for visual programming and creating node editor.
...
* [NoFlo](https://noflojs.org/) / [repo](https://github.com/noflo/noflo) ⭐ 3,550 | 🐛 29 | 🌐 JavaScript | 📅 2026-07-05. Flow-based programming for JavaScript.
